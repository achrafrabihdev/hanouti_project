...
<head>
    ...
    <title>hanouti - Modifier boutique</title>
    <style>
        #myForm{
            margin-top: 25vh;
        }
...
<nav class="navbar navbar-light bg-light fixed-top">
   ...
   <div class="alert alert-primary text-center">
    <strong>Modification de la boutique : <?=$b->nom?></strong>
    </div>
    <form style="color: #757575;" action="../controllers/boutiqueController.php?a=modifier" method="post">
      ...
      <div class="form-group">
        <input type="text" name="nom" class="form-control text-center" placeholder="Nom" value="<?=$b->nom?>">
      </div>
      <div class="form-group">
        <input type="text" name="ville" class="form-control text-center" placeholder="Ville" value="<?=$b->ville?>">
      </div>
      <div class="form-group">
        <input type="text" name="quartier" class="form-control text-center" placeholder="Quartier" value="<?=$b->quartier?>">
      </div>
